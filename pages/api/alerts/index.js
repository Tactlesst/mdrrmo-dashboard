...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === 'POST') {
      const { address, type, status, occurred_at, lat, lng, responder_id, responded_at } = req.body || {};
      ...
      const insert = await client.query(
        `INSERT INTO alerts (address, type, status, occurred_at, lat, lng, responder_id, responded_at)
         VALUES ($1, $2, COALESCE($3, 'Not Responded'), COALESCE($4, NOW()), $5, $6, $7, $8)
         RETURNING *`,
        [
          address || null,
          type || null,
